...
export const CONTRACT_TEMPLATES: ContractTemplate[] = [
  ...
  { id: 'ct22', name: 'Artisan Hemp Co.',           cropId: 'hemp',         amountRange: [400,  1800],  priceBonus: 1.28, termDays: 70,  penaltyRate: 0.25 },
  { id: 'ct23', name: 'Heritage Grain Bakery',       cropId: 'spelt',        amountRange: [600,  2500],  priceBonus: 1.30, termDays: 75,  penaltyRate: 0.25 },
  { id: 'ct24', name: 'Pulse Foods Inc.',            cropId: 'chickpeas',    amountRange: [800,  3000],  priceBonus: 1.22, termDays: 60,  penaltyRate: 0.20 },
  { id: 'ct25', name: 'Lentil Global Traders',       cropId: 'lentils',      amountRange: [800,  3000],  priceBonus: 1.25, termDays: 65,  penaltyRate: 0.22 },
  { id: 'ct26', name: 'Gourmet Spice House',         cropId: 'garlic',       amountRange: [200,   800],  priceBonus: 1.35, termDays: 50,  penaltyRate: 0.28 },
  { id: 'ct27', name: 'Hospital Catering Group',     cropId: 'potatoes',     amountRange: [3000, 10000], priceBonus: 1.18, termDays: 45,  penaltyRate: 0.15 },
  { id: 'ct28', name: 'School Lunch Programme',      cropId: 'corn',         amountRange: [2000,  8000], priceBonus: 1.16, termDays: 40,  penaltyRate: 0.12 },
  { id: 'ct29', name: 'Regional Hotel Chain',        cropId: 'tomatoes',     amountRange: [500,  2000],  priceBonus: 1.30, termDays: 35,  penaltyRate: 0.22 },
  { id: 'ct30', name: 'Organic Flour Mill',          cropId: 'wheat',        amountRange: [1500, 6000],  priceBonus: 1.40, termDays: 75,  penaltyRate: 0.30, minReputation: 40 },
  { id: 'ct31', name: 'Plant Protein Startup',       cropId: 'soy',          amountRange: [1000, 4000],  priceBonus: 1.35, termDays: 70,  penaltyRate: 0.28, minReputation: 30 },
  ...
  { id: 'exp06', name: 'Asian Hemp Fibre Market',   cropId: 'hemp',         amountRange: [600,  2500],  priceBonus: 1.65, termDays: 120, penaltyRate: 0.50, minReputation: 70,  export: true },
  { id: 'exp07', name: 'European Heritage Grains',  cropId: 'spelt',        amountRange: [800,  3000],  priceBonus: 1.70, termDays: 130, penaltyRate: 0.55, minReputation: 75,  export: true },
];
