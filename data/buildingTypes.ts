...
export const BUILDING_TYPES: BuildingType[] = [
  ...
  // ── Manure Store ──────────────────────────────────────────────
  {
    id: 'bld_manure_store_s',
    name: 'Small Manure Store',
    category: 'production',
    cost: 4500,
    maintenancePerDay: 2,
    capacity: 2000,
    effectLabel: 'Stores 2,000 kg of solid manure',
  },
  {
    id: 'bld_manure_store_m',
    name: 'Medium Manure Store',
    category: 'production',
    cost: 12000,
    maintenancePerDay: 5,
    capacity: 8000,
    effectLabel: 'Stores 8,000 kg of solid manure',
  },
  {
    id: 'bld_manure_store_l',
    name: 'Large Manure Store',
    category: 'production',
    cost: 28000,
    maintenancePerDay: 10,
    capacity: 25000,
    effectLabel: 'Stores 25,000 kg of solid manure',
  },
  // ── Compost Bay ───────────────────────────────────────────────
  {
    id: 'bld_compost_bay_s',
    name: 'Small Compost Bay',
    category: 'production',
    cost: 3500,
    maintenancePerDay: 1,
    capacity: 1,
    effectLabel: '1 active compost batch (open-air)',
  },
  {
    id: 'bld_compost_bay_m',
    name: 'Medium Compost Bay',
    category: 'production',
    cost: 9000,
    maintenancePerDay: 3,
    capacity: 3,
    effectLabel: '3 active compost batches (open-air)',
  },
  {
    id: 'bld_compost_bay_covered',
    name: 'Covered Compost Bay',
    category: 'production',
    cost: 16000,
    maintenancePerDay: 5,
    capacity: 3,
    effectLabel: '3 active compost batches (rain-immune, faster)',
  },
  // ── Soil Lab ──────────────────────────────────────────────────
  {
    id: 'bld_soil_lab',
    ...
    cost: 45000,
    maintenancePerDay: 8,
    effectLabel: 'Reduces soil analysis cost to $150/parcel, 1-day turnaround',
  },
