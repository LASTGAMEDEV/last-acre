...
export const CROP_TYPES: CropType[] = [
  ...
  { id: 'sugarbeet',    name: 'Sugar Beet',       tier: 'B', growthDays: 100, basePrice: 0.04,  seedCost: 400,  waterNeed: 3, fertilizerBonus: 1.3, unit: 'kg',  baseYield: 55000,  seasons: ['spring','summer'],          peakSeason: 'autumn',  fertilityDrain: 2, frostKillTemp: -3,  heatStressTemp: 34, droughtTolerance: 0.5 },
  ...
  // Tier A — Oil & fibre
  { id: 'sunflower',    name: 'Sunflower',        tier: 'A', growthDays: 95,  basePrice: 0.52,  seedCost: 280, waterNeed: 2, fertilizerBonus: 1.3, unit: 'kg', baseYield: 3800,  seasons: ['spring','summer'],          peakSeason: 'summer',  fertilityDrain: 1, frostKillTemp: -2,  heatStressTemp: 38, droughtTolerance: 0.8 },
  ...
  { id: 'strawberries', name: 'Strawberries',     tier: 'B', growthDays: 50,  basePrice: 2.20,  seedCost: 2200,  waterNeed: 4, fertilizerBonus: 1.3, unit: 'kg', baseYield: 8000,  seasons: ['spring'],                   peakSeason: 'spring',  fertilityDrain: 2, frostKillTemp: -2,  heatStressTemp: 32, droughtTolerance: 0.3 },
  // Tier A — Orchard
  { id: 'olives',       name: 'Olives',           tier: 'A', growthDays: 150, basePrice: 0.65,  seedCost: 900, waterNeed: 2, fertilizerBonus: 1.3, unit: 'kg', baseYield: 5000,  seasons: ['spring','autumn'],          peakSeason: 'autumn',  fertilityDrain: 1, frostKillTemp: -8,  heatStressTemp: 42, droughtTolerance: 0.7 },
  ...
  { id: 'lavender',     name: 'Lavender',         tier: 'S', growthDays: 150, basePrice: 80, seedCost: 4500, waterNeed: 2, fertilizerBonus: 1.3, unit: 'kg',  baseYield: 800,  seasons: ['spring','summer'],          peakSeason: 'summer',  fertilityDrain: 1, frostKillTemp: -8,  heatStressTemp: 38, droughtTolerance: 0.7 },
