...
export const INITIAL_MAP_FIELDS: MapField[] = [
  ...
  { id:'mf-nw7',  name:'Borde Aldea Este',  svgPath:'M 292,582 L 352,582 L 352,762 L 290,760 Z',    approximateHa:10,  labelX:322, labelY:672, owner:'forsale', fertility:60, askingPrice:16000, scouted:false },
  { id:'mf-nw8',  name:'Parcela Suroeste A',svgPath:'M 0,760 L 172,760 L 170,922 L 0,920 Z',        approximateHa:28,  labelX:86,  labelY:841, owner:'forsale', fertility:66, askingPrice:18500, scouted:false },
  ...
  // Row 1 (y: 0–182)
  { id:'mf-nc1',  name:'Camino Norte A',    svgPath:'M 352,0 L 530,0 L 528,182 L 352,180 Z',        approximateHa:32,  labelX:441, labelY:91,  owner:'forsale', fertility:63, askingPrice:17000, scouted:false },
  ...
  { id:'mf-nc4',  name:'Colina del Este A', svgPath:'M 872,0 L 1060,0 L 1043,182 L 870,182 Z',      approximateHa:34,  labelX:961, labelY:91,  owner:'forsale', fertility:69, askingPrice:19500, scouted:false },

  // Row 2 (y: 182–362)
  { id:'mf-nc5',  name:'Parcela Rivera I',  svgPath:'M 352,180 L 520,180 L 518,362 L 352,360 Z',    approximateHa:30,  labelX:436, labelY:271, owner:'forsale', fertility:67, askingPrice:19000, scouted:false },
  ...
  { id:'mf-nc8',  name:'Colina del Este B', svgPath:'M 862,182 L 1043,182 L 1025,362 L 860,362 Z',  approximateHa:32,  labelX:948, labelY:272, owner:'forsale', fertility:72, askingPrice:21000, scouted:false },
  ...
  { id:'mf-nc12', name:'Ladera Norte',      svgPath:'M 852,362 L 1025,362 L 1005,542 L 850,542 Z',  approximateHa:30,  labelX:933, labelY:452, owner:'forsale', fertility:74, askingPrice:21500, scouted:false },
  ...
  { id:'mf-nc16', name:'Loma del Río I',    svgPath:'M 842,542 L 1005,542 L 987,722 L 840,722 Z',   approximateHa:29,  labelX:919, labelY:632, owner:'forsale', fertility:66, askingPrice:18500, scouted:false },
  ...
  { id:'mf-nc20', name:'Margen del Río I',  svgPath:'M 830,722 L 987,722 L 963,922 L 828,922 Z',    approximateHa:30,  labelX:902, labelY:822, owner:'forsale', fertility:70, askingPrice:20000, scouted:false },
  ...
  { id:'mf-ne6',  name:'Pradera Este B',    svgPath:'M 1182,402 L 1400,402 L 1400,602 L 1180,602 Z', approximateHa:44,  labelX:1291,labelY:502, owner:'forsale', fertility:67, askingPrice:19000, scouted:false },
  { id:'mf-ne7',  name:'Terreno Este A',    svgPath:'M 1002,602 L 1162,602 L 1160,802 L 982,802 Z',  approximateHa:32,  labelX:1077,labelY:702, owner:'forsale', fertility:62, askingPrice:16500, scouted:false },
  { id:'mf-ne8',  name:'Terreno Este B',    svgPath:'M 1162,602 L 1400,602 L 1400,802 L 1160,802 Z', approximateHa:48,  labelX:1281,labelY:702, owner:'forsale', fertility:69, askingPrice:19500, scouted:false },
  { id:'mf-ne9',  name:'Borde Sur NE A',    svgPath:'M 982,802 L 1162,802 L 1160,922 L 963,922 Z',   approximateHa:23,  labelX:1067,labelY:862, owner:'forsale', fertility:71, askingPrice:20500, scouted:false },
  ...
  { id:'mf-st3',  name:'Borde Río Norte',   svgPath:'M 722,920 L 963,920 L 959,1002 L 720,1002 Z',  approximateHa:20,  labelX:841, labelY:961, owner:'forsale', fertility:64, askingPrice:17500, scouted:false },
  ...
  { id:'mf-se1',  name:'Campiña SE A',      svgPath:'M 963,920 L 1162,920 L 1158,1082 L 945,1082 Z', approximateHa:31,  labelX:1057,labelY:1001,owner:'forsale', fertility:69, askingPrice:19500, scouted:false },
  { id:'mf-se2',  name:'Campiña SE B',      svgPath:'M 1162,920 L 1400,920 L 1400,1082 L 1158,1082 Z',approximateHa:42, labelX:1280,labelY:1001,owner:'forsale', fertility:65, askingPrice:18000, scouted:false },
  { id:'mf-se3',  name:'Llanura SE A',      svgPath:'M 945,1082 L 1122,1082 L 1118,1262 L 925,1262 Z',approximateHa:31, labelX:1028,labelY:1172,owner:'forsale', fertility:72, askingPrice:21000, scouted:false },
