...
function GeneChips({ genes }: { genes: SeedGenes }) {
  const items = [
    { key: 'yield',   label: 'Yld', color: C.green },
...
const slStyles = StyleSheet.create({
  ...
  statusBadge:        { color: C.green, fontSize: 11, fontWeight: 'bold', marginHorizontal: S.md, marginBottom: S.sm },
  ...
  jobDays:            { color: C.green, fontSize: 11, fontWeight: 'bold' },
